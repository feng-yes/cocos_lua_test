...
-- 模拟单位改变位置后是否合法
local function isUnitNoCrash(oUnit)
...
local function doRigiUnitInCrash(unit1, unit2)
    ...
    rigi1.lCenter = {bRigi1Left and rigi1X - nRigi1MoveX or rigi1X + nRigi1MoveX, bRigi1Up and rigi1Y - nRigi1MoveY or rigi1Y + nRigi1MoveY}
    rigi2.lCenter = {bRigi1Left and rigi2X + nRigi2MoveX or rigi2X - nRigi2MoveX, bRigi1Up and rigi2Y + nRigi2MoveY or rigi2Y - nRigi2MoveY}

    local bUnit1TryFirst = isUnitNoCrash(unit1)
    local bUnit2TryFirst = isUnitNoCrash(unit2)
